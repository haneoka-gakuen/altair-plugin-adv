...
import { cloneStoryValue, findStoryScene, type JsonObject, type StoryProject } from "@haneoka/altair/model";
import type { AltairCompilerPassContribution } from "@haneoka/altair/plugins";
...
/** Compile one scene into the open JSON shape consumed by Vega ADV runtimes. */
